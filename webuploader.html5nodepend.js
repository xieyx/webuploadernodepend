    ...
    define('dollar-builtin',[],function() {
        ...
        function $( elem ) {
            ...
            return $.extend( api, {
                ...
                trigger: function(_event, data) {
                    if (window.CustomEvent) {
                        var event = new CustomEvent(_event, {detail: data, bubbles: true, cancelable: true});
                    } else {
                        var event = document.createEvent('CustomEvent');
                        event.initCustomEvent(_event, true, true, data);
                    }

                    var cb = elem.dispatchEvent(event);
                    console.log(cb)
                },
                ...
                offset: function(ops) {
                    if(ops) {
                        ...
                        $(elem).css({
                            top: ops.top - parentOffset.top + 'px',
                            left: ops.left - parentOffset.left + 'px'
                        });
                        return ;
                    }
        ...
        $.map = function(_array, _callback) {
            var getValues = function(source){  
            ...
            return getValues(_array).map(_callback)
        };
        ...
        return Html5Runtime.register( 'FilePicker', {
            init: function() {
                ...
                label.on( 'click', function(e) {
                    input.off('aclick', aclick).on('aclick', aclick)
                    input.trigger('aclick');
                    e.stopPropagation();
